...
THEME_VARIABLES = {
    ...
    "template_name": "Radhe",
    "template_suffix": "Admin Panel",
    "template_version": "2.0.0",
    "template_free": True,
    "template_description": "Radhe is a tools and hardware shop admin panel designed for managing inventory, sales, suppliers, and daily operations efficiently.",
    "template_keyword": "Radhe",
